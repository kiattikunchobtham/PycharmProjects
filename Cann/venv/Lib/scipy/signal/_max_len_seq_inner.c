 ...
 *                        Py_ssize_t nbits, Py_ssize_t length,
 */
  __pyx_tuple__31 = PyTuple_Pack(10, __pyx_n_s_taps, __pyx_n_s_state, __pyx_n_s_nbits, __pyx_n_s_length, __pyx_n_s_seq, __pyx_n_s_n_taps, __pyx_n_s_idx, __pyx_n_s_feedback, __pyx_n_s_i, __pyx_n_s_ti); if (unlikely(!__pyx_tuple__31)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__31);
  __Pyx_GIVEREF(__pyx_tuple__31);
  __pyx_codeobj__32 = (PyObject*)__Pyx_PyCode_New(5, 0, 10, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__31, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_max_len_seq_inner_pyx, __pyx_n_s_max_len_seq_inner, 15, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__32)) __PYX_ERR(0, 15, __pyx_L1_error)
...
static int __pyx_pymod_exec__max_len_seq_inner(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init scipy.signal._max_len_seq_inner", 0, __pyx_lineno, __pyx_filename);
    }
