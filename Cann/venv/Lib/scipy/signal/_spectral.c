...
static PyMethodDef __pyx_mdef_5scipy_6signal_9_spectral_1_lombscargle = {"_lombscargle", (PyCFunction)__pyx_pw_5scipy_6signal_9_spectral_1_lombscargle, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5scipy_6signal_9_spectral__lombscargle};
...
static int __pyx_pymod_exec__spectral(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init scipy.signal._spectral", 0, __pyx_lineno, __pyx_filename);
    }
